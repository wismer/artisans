...
<span class="nv">module.exports = </span><span class="k">class</span> <span class="nx">Snockets</span>
  <span class="nv">constructor: </span><span class="nf">(@options = {}) -&gt;</span>
    <span class="nx">@options</span><span class="p">.</span><span class="nx">src</span> <span class="o">?=</span> <span class="s1">&#39;.&#39;</span>
    ...
    <span class="vi">@depGraph = </span><span class="k">new</span> <span class="nx">DepGraph</span></pre></div>             </td>           </tr>                               <tr id="section-2">             <td class="docs">               <div class="pilwrap">                 <a class="pilcrow" href="#section-2">&#182;</a>               </div>               <h2>Public methods</h2>             </td>             <td class="code">               <div class="highlight"><pre>  <span class="nv">scan: </span><span class="nf">(filePath, flags, callback) -&gt;</span>
  ...
  <span class="nv">getConcatenation: </span><span class="nf">(filePath, flags, callback) -&gt;</span>
    ...
    <span class="nv">q = </span><span class="k">new</span> <span class="nx">HoldingQueue</span>
      <span class="nv">task: </span><span class="p">(</span><span class="nx">depPath</span><span class="p">,</span> <span class="nx">next</span><span class="p">)</span> <span class="o">=&gt;</span>
        <span class="k">return</span> <span class="nx">next</span><span class="p">()</span> <span class="nx">unless</span> <span class="nx">path</span><span class="p">.</span><span class="nx">extname</span><span class="p">(</span><span class="nx">depPath</span><span class="p">)</span> <span class="k">in</span> <span class="nx">jsExts</span><span class="p">()</span>
        ...
        <span class="nx">@updateDirectives</span> <span class="nx">depPath</span><span class="p">,</span> <span class="nx">flags</span><span class="p">,</span> <span class="nx">excludes</span><span class="p">...,</span> <span class="nf">(err) -&gt;</span>
    ...
    <span class="nv">require = </span><span class="p">(</span><span class="nx">relPath</span><span class="p">)</span> <span class="o">=&gt;</span>
      ...
      <span class="k">else</span>
        <span class="nv">depName = </span><span class="nx">path</span><span class="p">.</span><span class="nx">join</span> <span class="nx">path</span><span class="p">.</span><span class="nx">dirname</span><span class="p">(</span><span class="nx">filePath</span><span class="p">),</span> <span class="nx">relName</span>
    ...
    <span class="nv">requireTree = </span><span class="p">(</span><span class="nx">dirName</span><span class="p">)</span> <span class="o">=&gt;</span>
      ...
      <span class="nx">@readdir</span> <span class="nx">@absPath</span><span class="p">(</span><span class="nx">dirName</span><span class="p">),</span> <span class="nx">flags</span><span class="p">,</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">items</span><span class="p">)</span> <span class="o">=&gt;</span>
        ...
        <span class="k">for</span> <span class="nx">item</span> <span class="k">in</span> <span class="nx">items</span>
          <span class="nv">itemPath = </span><span class="nx">path</span><span class="p">.</span><span class="nx">join</span> <span class="nx">dirName</span><span class="p">,</span> <span class="nx">item</span>
        ...
        <span class="k">switch</span> <span class="nx">command</span>
          ...
          <span class="k">when</span> <span class="s1">&#39;require_tree&#39;</span>
            <span class="k">for</span> <span class="nx">relPath</span> <span class="k">in</span> <span class="nx">relPaths</span>
              <span class="nx">requireTree</span> <span class="nx">path</span><span class="p">.</span><span class="nx">join</span> <span class="nx">path</span><span class="p">.</span><span class="nx">dirname</span><span class="p">(</span><span class="nx">filePath</span><span class="p">),</span> <span class="nx">relPath</span>

      <span class="nx">q</span><span class="p">.</span><span class="nx">finalize</span><span class="p">()</span></pre></div>             </td>           </tr>                               <tr id="section-5">             <td class="docs">               <div class="pilwrap">                 <a class="pilcrow" href="#section-5">&#182;</a>               </div>               <p>Searches for a file with the given name (no extension, e.g. <code>'foo/bar'</code>)</p>             </td>             <td class="code">               <div class="highlight"><pre>  <span class="nv">findMatchingFile: </span><span class="nf">(filename, flags, callback) -&gt;</span>
    <span class="nv">tryFiles = </span><span class="p">(</span><span class="nx">filePaths</span><span class="p">)</span> <span class="o">=&gt;</span>
    ...
    <span class="nx">@readdir</span> <span class="nx">path</span><span class="p">.</span><span class="nx">dirname</span><span class="p">(</span><span class="nx">@absPath</span> <span class="nx">filename</span><span class="p">),</span> <span class="nx">flags</span><span class="p">,</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">files</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="k">return</span> <span class="nx">callback</span> <span class="nx">err</span> <span class="k">if</span> <span class="nx">err</span>
      <span class="k">return</span> <span class="k">if</span> <span class="nx">tryFiles</span> <span class="p">(</span><span class="k">for</span> <span class="nx">file</span> <span class="k">in</span> <span class="nx">files</span>
        <span class="nx">path</span><span class="p">.</span><span class="nx">join</span> <span class="nx">path</span><span class="p">.</span><span class="nx">dirname</span><span class="p">(</span><span class="nx">filename</span><span class="p">),</span> <span class="nx">file</span>
      <span class="p">)</span>
      <span class="nx">callback</span> <span class="k">new</span> <span class="nb">Error</span><span class="p">(</span><span class="s2">&quot;File not found: &#39;#{filename}&#39;&quot;</span><span class="p">)</span></pre></div>             </td>           </tr>                               <tr id="section-6">             <td class="docs">               <div class="pilwrap">                 <a class="pilcrow" href="#section-6">&#182;</a>               </div>               <p>Wrapper around fs.readdir or fs.readdirSync, depending on flags.async.</p>             </td>             <td class="code">               <div class="highlight"><pre>  <span class="nv">readdir: </span><span class="nf">(dir, flags, callback) -&gt;</span>
    ...
    <span class="k">else</span>
      ...
      <span class="k">catch</span> <span class="nx">e</span>
        <span class="nx">callback</span> <span class="nx">e</span></pre></div>             </td>           </tr>                               <tr id="section-7">             <td class="docs">               <div class="pilwrap">                 <a class="pilcrow" href="#section-7">&#182;</a>               </div>               <p>Wrapper around fs.stat or fs.statSync, depending on flags.async.</p>             </td>             <td class="code">               <div class="highlight"><pre>  <span class="nv">stat: </span><span class="nf">(filePath, flags, callback) -&gt;</span>
    <span class="k">if</span> <span class="nx">flags</span><span class="p">.</span><span class="nx">async</span>
    ...
    <span class="k">else</span>
      ...
      <span class="k">catch</span> <span class="nx">e</span>
        <span class="nx">callback</span> <span class="nx">e</span></pre></div>             </td>           </tr>                               <tr id="section-8">             <td class="docs">               <div class="pilwrap">                 <a class="pilcrow" href="#section-8">&#182;</a>               </div>               <p>Reads a file's data and timestamp into the cache.</p>             </td>             <td class="code">               <div class="highlight"><pre>  <span class="nv">readFile: </span><span class="nf">(filePath, flags, callback) -&gt;</span>
  ...
  <span class="nv">absPath: </span><span class="nf">(relPath) -&gt;</span>
    ...
    <span class="k">else</span> <span class="k">if</span> <span class="nx">@options</span><span class="p">.</span><span class="nx">src</span><span class="p">.</span><span class="nx">match</span> <span class="nx">EXPLICIT_PATH</span>
      <span class="nx">path</span><span class="p">.</span><span class="nx">join</span> <span class="nx">@options</span><span class="p">.</span><span class="nx">src</span><span class="p">,</span> <span class="nx">relPath</span>
    <span class="k">else</span>
      <span class="nx">path</span><span class="p">.</span><span class="nx">join</span> <span class="nx">process</span><span class="p">.</span><span class="nx">cwd</span><span class="p">(),</span> <span class="nx">@options</span><span class="p">.</span><span class="nx">src</span><span class="p">,</span> <span class="nx">relPath</span></pre></div>             </td>           </tr>                               <tr id="section-9">             <td class="docs">               <div class="pilwrap">                 <a class="pilcrow" href="#section-9">&#182;</a>               </div>               <h2>Compilers</h2>             </td>             <td class="code">               <div class="highlight"><pre><span class="nv">module.exports.compilers = compilers =</span>
  <span class="nv">coffee:</span>
    ...
    <span class="nv">compileSync: </span><span class="nf">(sourcePath, source) -&gt;</span>
      <span class="nx">CoffeeScript</span><span class="p">.</span><span class="nx">compile</span> <span class="nx">source</span><span class="p">,</span> <span class="p">{</span><span class="nv">filename: </span><span class="nx">sourcePath</span><span class="p">}</span></pre></div>             </td>           </tr>                               <tr id="section-10">             <td class="docs">               <div class="pilwrap">                 <a class="pilcrow" href="#section-10">&#182;</a>               </div>               <h2>Regexes</h2>             </td>             <td class="code">               <div class="highlight"><pre><span class="nv">EXPLICIT_PATH = </span><span class="sr">/^\/|^\.|:/</span>
...
<span class="err">///gm</span></pre></div>             </td>           </tr>                               <tr id="section-11">             <td class="docs">               <div class="pilwrap">                 <a class="pilcrow" href="#section-11">&#182;</a>               </div>               <h2>Utility functions</h2>             </td>             <td class="code">               <div class="highlight"><pre><span class="k">class</span> <span class="nx">HoldingQueue</span>
...
<span class="nv">stripExt = </span><span class="nf">(filePath) -&gt;</span>
  <span class="k">if</span> <span class="nx">path</span><span class="p">.</span><span class="nx">extname</span><span class="p">(</span><span class="nx">filePath</span><span class="p">)</span> <span class="k">in</span> <span class="nx">jsExts</span><span class="p">()</span>
    <span class="nx">filePath</span><span class="p">[</span><span class="mi">0</span><span class="p">...</span><span class="nx">filePath</span><span class="p">.</span><span class="nx">lastIndexOf</span><span class="p">(</span><span class="s1">&#39;.&#39;</span><span class="p">)]</span>
  <span class="k">else</span>
    <span class="nx">filePath</span>

<span class="nv">jsExts = </span><span class="o">-&gt;</span>
  <span class="p">(</span><span class="s2">&quot;.#{ext}&quot;</span> <span class="k">for</span> <span class="nx">ext</span> <span class="k">of</span> <span class="nx">compilers</span><span class="p">).</span><span class="nx">concat</span> <span class="s1">&#39;.js&#39;</span>
